                ...
                <div className="personal w-full">
                  ...
                  <div className="w-full md:w-full px-3 mb-6">
                    ...
                    <textarea
                      ...
                      onChange={(e) => this.handleInputChanges(e)}
                      name="description"
                      className="bg-gray-100 rounded-md leading-normal resize-none w-full h-20 py-2 px-3 shadow-inner border border-gray-400 font-medium placeholder-gray-500 focus:outline-none focus:bg-white"
